 ...
 */
export function getReference(identifier: RecordIdentifier): [string, string | number] {
	const fieldName = identifier.id ? "id" : "id_ref";
	const fieldValue = identifier.id ? identifier.id : identifier.id_ref;
